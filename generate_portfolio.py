...
def generate_markdown(repo):
    markdown_content = f"# {repo['name']}" # Title of the repository
    markdown_content += f"## Description" # Subtitle for the description
    markdown_content += f"{repo['description'] if repo['description'] else 'No description avaliable!'}\n\n" # Description of the repository
